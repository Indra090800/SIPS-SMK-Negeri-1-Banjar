...
class ModelAdmin extends Model
{
    ...
    {
        return $this->db->table('tbl_gedung')->countAll();
    }

    public function jml_ruangan()
    {
        return $this->db->table('tbl_ruangan')->countAll();
    }
    ...
    {
        return $this->db->table('tbl_prodi')->countAll();
    }

    public function jml_matkul()
    {
        return $this->db->table('tbl_matkul')->countAll();
    }

    public function jml_mhs()
    {
        return $this->db->table('tbl_mhs')->countAll();
    }

    public function jml_dosen()
    {
        return $this->db->table('tbl_dosen')->countAll();
    }
